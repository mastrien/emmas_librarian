...
- **Projetos:** `id, nome, data_criacao, ultima_execucao`.
- **Artigos:** `id, projeto_id, doi, titulo, autores, ano, query_origem, base_origem (JSON list), csl_json (raw content), status (novo/lido/arquivado)`.

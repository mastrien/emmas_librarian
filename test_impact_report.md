...
* **Manutenção no Git:** Complexa. O arquivo gerado é um XML muito verboso de 160+ lines para apenas 5 requisições simples, tornando revisões de código de diffs inviáveis.

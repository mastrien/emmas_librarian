        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '1rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', alignItems: 'center' }}>
              {databases.map(db => (
                <span key={db} style={{ padding: '0.2rem 0.6rem', background: 'rgba(79, 70, 229, 0.1)', border: '1px solid var(--color-primary)', borderRadius: 'var(--radius-xl)', fontSize: '0.75rem', fontWeight: 600, color: 'var(--color-primary)' }}>
                  {db}
                </span>
              ))}
              <span style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', overflowY: 'visible' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600 }}>ANO DE PUBLICAÇÃO</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600 }}>REVISTA / PERIÓDICO</div>
                <div style={{ fontSize: '0.9rem', color: 'var(--text-main)', fontStyle: 'italic' }}>{article.journal || 'N/A'}</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600 }}>VOLUME / EDIÇÃO / PÁGINAS</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600 }}>TIPO DE DOCUMENTO</div>
                <div style={{ fontSize: '0.9rem', color: 'var(--text-main)', textTransform: 'capitalize' }}>{article.document_type || 'N/A'}</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600 }}>EDITORA (PUBLISHER)</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.9rem', color: 'var(--text-main)', fontWeight: 600 }}>
                  🎓 {article.citation_count !== undefined && article.citation_count !== null ? article.citation_count : '0'}
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.9rem', color: 'var(--text-main)', wordBreak: 'break-all' }}>
                  {article.doi ? (
                    <a href={`https://doi.org/${article.doi}`} target="_blank" rel="noreferrer" style={{ color: 'var(--color-primary)', textDecoration: 'none' }} onMouseEnter={e => e.currentTarget.style.textDecoration = 'underline'} onMouseLeave={e => e.currentTarget.style.textDecoration = 'none'}>
                      {article.doi}
                    </a>
                  ) : (
                    'N/A'
          ...
          {article.affiliations && (
            <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem' }}>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600, marginBottom: '0.25rem' }}>AFILIAÇÕES</div>
          ...
          {/* Abstract */}
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem' }}>
            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600, marginBottom: '0.5rem' }}>RESUMO (ABSTRACT)</div>
            <div 
              style={{ 
                fontSize: '0.9rem', 
                color: 'var(--text-main)', 
          ...
          {(authorKeywords.length > 0 || indexKeywords.length > 0) && (
            <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {authorKeywords.length > 0 && (
                <div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600, marginBottom: '0.4rem', display: 'flex', alignItems: 'center', gap: '0.25rem' }}><Tag size={12} /> PALAVRAS-CHAVE DO AUTOR</div>
                  <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
                    {authorKeywords.map(tag => (
                      <span key={tag} style={{ padding: '0.2rem 0.5rem', background: 'var(--bg-surface)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-sm)', fontSize: '0.8rem', color: 'var(--text-main)' }}>
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              {indexKeywords.length > 0 && (
                <div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600, marginBottom: '0.4rem', display: 'flex', alignItems: 'center', gap: '0.25rem' }}><Tag size={12} /> PALAVRAS-CHAVE INDEXADAS</div>
                  <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
          ...
          {article.references_list && (
            <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem' }}>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600, marginBottom: '0.5rem' }}>REFERÊNCIAS CITADAS</div>
              <div 
                style={{ 
                  fontSize: '0.8rem', 
                  color: 'var(--text-main)', 
              ...
              >
                <ol style={{ margin: 0, paddingLeft: '1.25rem' }}>
                  {article.references_list.split(';').map((ref, idx) => (
                    <li key={idx} style={{ marginBottom: '0.5rem' }}>{ref.trim()}</li>
                  ))}
                </ol>
              </div>
            </div>

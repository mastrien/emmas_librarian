                  ...
                  {onRevertSearch && (
                    <button
                      onClick={() => {
                        if (
                          window.confirm(
                            'Deseja realmente desfazer esta busca? Todos os artigos importados por ela serão removidos permanentemente.',
                          )
                        ) {
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                ...
                <div>
                  ...
                  <details style={{ fontSize: '0.8rem', cursor: 'pointer' }}>
                    <summary style={{ color: 'var(--color-primary)', fontWeight: 500 }}>
                      Ver detalhes da tradução
                    </summary>

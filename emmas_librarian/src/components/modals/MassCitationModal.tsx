...
export function MassCitationModal({ isOpen, onClose, articles, onArticlesUpdated }: MassCitationModalProps) {
  ...
  const handleResetEdit = () => {
    ...
    if (editingArticle.csl_json) {
      try {
        const csl =
          typeof editingArticle.csl_json === 'string' ? JSON.parse(editingArticle.csl_json) : editingArticle.csl_json;
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            {format === 'html' ? <span dangerouslySetInnerHTML={{ __html: citText }} /> : citText}
                          </div>
                          <button

...
const routes: RouteCase[] = [
  ...
  { method: 'getProject', call: () => api.getProject(1), channel: IpcChannel.PROJECTS_GET_ONE, args: [1] },
  {
    ...
    call: () => api.updateProject(1, 'N'),
    channel: IpcChannel.PROJECTS_UPDATE,
    args: [1, 'N'],
  },
  {
    method: 'getProjectWritingPad',
    call: () => api.getProjectWritingPad(1),
    channel: IpcChannel.PROJECTS_GET_WRITING_PAD,
    args: [1],
  },
  {
    method: 'updateProjectWritingPad',
    call: () => api.updateProjectWritingPad(1, 'c'),
    channel: IpcChannel.PROJECTS_UPDATE_WRITING_PAD,
    args: [1, 'c'],
  },
  { method: 'deleteProject', call: () => api.deleteProject(1), channel: IpcChannel.PROJECTS_DELETE, args: [1] },
  {
    method: 'getSearchHistory',
    call: () => api.getSearchHistory(1),
    channel: IpcChannel.PROJECTS_GET_SEARCH_HISTORY,
    args: [1],
  },
  ...
  {
    method: 'exportBiblioshiny',
    call: () => api.exportBiblioshiny(1),
    channel: IpcChannel.EXPORT_BIBLIOSHINY,
    args: [1],
  },
  ...
  { method: 'getAnnotations', call: () => api.getAnnotations(2), channel: IpcChannel.ANNOTATIONS_GET, args: [2] },
  {
    ...
    call: () => api.updateAnnotation(3, 'c'),
    channel: IpcChannel.ANNOTATIONS_UPDATE,
    args: [3, 'c'],
  },
  {
    method: 'deleteAnnotation',
    call: () => api.deleteAnnotation(3),
    channel: IpcChannel.ANNOTATIONS_DELETE,
    args: [3],
  },
  ...
  {
    method: 'getAiModelConfigs',
    call: () => api.getAiModelConfigs(),
    channel: IpcChannel.AI_MODEL_CONFIG_GET_ALL,
    args: [],
  },
  {
  ...
  {
    method: 'restoreAiModelConfigDefaults',
    call: () => api.restoreAiModelConfigDefaults(),
    channel: IpcChannel.AI_MODEL_CONFIG_RESTORE,
    args: [],
  },
  { method: 'openPdfDialog', call: () => api.openPdfDialog(), channel: IpcChannel.DIALOG_OPEN_FILE, args: [] },
  {
    method: 'openMultiplePdfsDialog',
    call: () => api.openMultiplePdfsDialog(),
    channel: IpcChannel.DIALOG_OPEN_MULTIPLE_FILES,
    args: [],
  },
  {
    method: 'saveExportedFile',
    call: () => api.saveExportedFile('c', 'f.csv'),
    channel: IpcChannel.DIALOG_SAVE_FILE,
    args: ['c', 'f.csv'],
  },
  ...
  {
    method: 'deletePdfLibraryRecord',
    call: () => api.deletePdfLibraryRecord('/a.pdf'),
    channel: IpcChannel.PDF_LIBRARY_DELETE,
    args: ['/a.pdf'],
  },
  {
    method: 'linkPdfToArticle',
    call: () => api.linkPdfToArticle(2, '/a.pdf'),
    channel: IpcChannel.PDF_LIBRARY_LINK,
    args: [2, '/a.pdf'],
  },
  {
    method: 'uploadPdfToLibrary',
    call: () => api.uploadPdfToLibrary('/a.pdf'),
    channel: IpcChannel.PDF_LIBRARY_UPLOAD,
    args: ['/a.pdf'],
  },
  {
  ...
  { method: 'getDiaryEntries', call: () => api.getDiaryEntries(1), channel: IpcChannel.DIARY_GET_ALL, args: [1] },
  {
    ...
    call: () => api.getDiaryEntry(1, '2026-01-01'),
    channel: IpcChannel.DIARY_GET_ONE,
    args: [1, '2026-01-01'],
  },
  {
  ...
  },
  {
    ...
    call: () => api.deleteDiaryEntry(1, '2026-01-01'),
    channel: IpcChannel.DIARY_DELETE,
    args: [1, '2026-01-01'],
  },
  { method: 'getTrashItems', call: () => api.getTrashItems(), channel: IpcChannel.TRASH_GET_ITEMS, args: [] },
  {
    method: 'restoreTrashItem',
    call: () => api.restoreTrashItem('article', 2),
    channel: IpcChannel.TRASH_RESTORE_ITEM,
    args: ['article', 2],
  },
  {
  ...
  { method: 'listAutoBackups', call: () => api.listAutoBackups(), channel: IpcChannel.BACKUP_LIST_AUTO, args: [] },
  {
    ...
    call: () => api.restoreAutoBackup('b.zip'),
  ...
  {
    method: 'massiveExtraction',
    call: () => api.massiveExtraction(2, ['q']),
    channel: IpcChannel.AI_MASSIVE_EXTRACTION,
    args: [2, ['q']],
  },
  { method: 'extractMetadata', call: () => api.extractMetadata(2), channel: IpcChannel.AI_EXTRACT_METADATA, args: [2] },
  {
    method: 'getPendingHighlights',
    call: () => api.getPendingHighlights(2),
    channel: IpcChannel.PENDING_HIGHLIGHTS_GET,
    args: [2],
  },
  {
    method: 'deletePendingHighlight',
    call: () => api.deletePendingHighlight(8),
    channel: IpcChannel.PENDING_HIGHLIGHTS_DELETE,
    args: [8],
  },
  {
    method: 'getProjectDocuments',
    call: () => api.getProjectDocuments(1),
    channel: IpcChannel.PROJECT_DOCUMENTS_GET,
    args: [1],
  },
  {
  ...
  },
  {
    ...
    call: () => api.deleteProjectDocument(3),
    channel: IpcChannel.PROJECT_DOCUMENTS_DELETE,
    args: [3],
  },
  {
  ...
  {
    method: 'getMassiveInvestigations',
    call: () => api.getMassiveInvestigations(1),
    channel: IpcChannel.MASSIVE_INVESTIGATIONS_GET,
    args: [1],
  },
  {
  ...
  },
  {
    ...
    call: () => api.getInvestigationResults(4),
    channel: IpcChannel.INVESTIGATION_RESULTS_GET,
    args: [4],
  },
  {
  ...
  {
    method: 'getProjectCategories',
    call: () => api.getProjectCategories(1),
    channel: IpcChannel.CATEGORIES_GET_PROJECT,
    args: [1],
  },
  {
  ...
  },
  {
    ...
    call: () => api.deleteProjectCategory(5),
    channel: IpcChannel.CATEGORIES_DELETE_PROJECT,
    args: [5],
  },
  {
    method: 'getArticleCategories',
    call: () => api.getArticleCategories(2),
    channel: IpcChannel.CATEGORIES_GET_ARTICLE,
    args: [2],
  },
  {
  ...
  { method: 'getQuestionSet', call: () => api.getQuestionSet(6), channel: IpcChannel.QUESTION_SETS_GET, args: [6] },
  {
    ...
    call: () => api.createQuestionSet(questionSet),
    channel: IpcChannel.QUESTION_SETS_CREATE,
    args: [questionSet],
  },
  {
  ...
  {
    method: 'deleteQuestionSet',
    call: () => api.deleteQuestionSet(6),
    channel: IpcChannel.QUESTION_SETS_DELETE,
    args: [6],
  },
  {
    method: 'duplicateQuestionSet',
    call: () => api.duplicateQuestionSet(6, 1),
    channel: IpcChannel.QUESTION_SETS_DUPLICATE,
    args: [6, 1],
  },
  { method: 'exportProject', call: () => api.exportProject(1), channel: IpcChannel.SYNC_EXPORT_PROJECT, args: [1] },
  {
    method: 'importProject',
    call: () => api.importProject('/p.zip'),
    channel: IpcChannel.SYNC_IMPORT_PROJECT,
    args: ['/p.zip'],
  },
  {
    method: 'getScientificVenues',
    call: () => api.getScientificVenues(),
    channel: IpcChannel.SCIENTIFIC_VENUES_GET_ALL,
    args: [],
  },
  {
    method: 'createScientificVenue',
    call: () => api.createScientificVenue(venue),
    channel: IpcChannel.SCIENTIFIC_VENUE_CREATE,
    args: [venue],
  },
  {
    method: 'deleteScientificVenue',
